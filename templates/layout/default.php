    ...
    /* Let children of nav-left / nav-right participate directly
       in the nav grid (no layout boxes of their own) */
        ...
        @media (max-width: 639px) {
            ...
            /* ============================================
            MY LISTINGS TABLE → MINIMAL CARDS ON MOBILE
            Only show Product name + View link
            ============================================ */
            ...
            /* ============================================
            DASHBOARD SAVED LISTINGS — 1 AT A TIME WITH ARROWS
            Higher specificity to beat template-level !important
            ============================================ */
